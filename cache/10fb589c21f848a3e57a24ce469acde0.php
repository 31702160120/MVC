...
<body leftmargin="8" topmargin="8" background='./public/skin/images/allbg.gif'>

<!--  快速转换位置按钮  -->
<table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D1DDAA" align="center">
<tr>
 <td height="26" background="./public/skin/images/newlinebg3.gif">
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  <td align="center">
    <input type='button' class="coolbg np" onClick="location='index.php?m=Loadd_news&cid=<?=$cid;?>';" value='添加文档' />
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="./public/skin/images/tbg.gif">&nbsp;文档列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><?=$value['id'];?></td>
	<td align="left"><a href=''><u><?=$value['title'];?></u></a></td>
	<td><?=$value['publishTime'];?></td>
	<td><?=$value['categoryId'];?></td>
	<td><?=$value['clicked'];?></td>
	<td><?=$value['author'];?></td>
	<td><a href="index.php?m=Lonews&id=<?=$value['id'];?>">编辑</a> |
	<a href="index.php?m=Logl_news&a=delNews&id=<?=$value['id'];?>&cid=<?=$value['categoryId'];?>">删除</a></td>
</tr>
<?php endforeach ?>
<?php } ?>
<!-- <tr bgcolor="#FAFAF1">
...
<table width='98%'  border='0' cellpadding='1' cellspacing='1' bgcolor='#CBD8AC' align="center" style="margin-top:8px">
  <tr bgcolor='#EEF4EA'>
    <td background='./public/skin/images/wbg.gif' align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        ...
        <td>
          <input name="imageField" type="image" src="./public/skin/images/frame/search.gif" width="45" height="20" border="0" class="np" />
        </td>
       </tr>
      </table>
    </td>
